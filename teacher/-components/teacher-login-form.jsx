...
export const LoginForm = memo(function LoginForm({ className, ...props }) {
  const {
    register,
    handleSubmit,
    reset,
        ...
        <Card className={cn(
          ...
          <CardHeader className="space-y-4 pb-6">
            <div className="flex items-center justify-center w-16 h-16 rounded-full mx-auto shadow-lg">
              <img src="/images/main-logo.jpg" alt="Bruce LMS" width={64} height={64} loading="lazy" decoding="async"/>
            </div>
