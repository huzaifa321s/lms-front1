...
export function BackgroundCircles({
    ...
    return (
        ...
        >
            <AnimatedGrid />
            <motion.div className="absolute h-[100px] w-[100px] max-h-[70vh] max-w-[70vw]">
                {[0, 1, 2].map((i) => (
                    <motion.div
                        key={i}
                        className={cn(
            ...
            >
                <h1
                    className={cn(
                        "text-xl font-bold tracking-tight md:text-2xl mt-5 ",
...
export { COLOR_VARIANTS ,AnimatedGrid};
