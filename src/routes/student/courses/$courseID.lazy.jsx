...
export const Route = createLazyFileRoute('/student/courses/$courseID')({
  beforeLoad: ({ params }) => {
...
const [openMaterial, setOpenMaterial] = useState(null);
  ...
  <AccordionItem
    ...
    className="rounded-xl border border-slate-200 bg-white shadow-md hover:shadow-lg transition-all"
  >
    {/* Accordion Header */}
    <AccordionTrigger className="px-6 py-4 hover:no-underline [&[data-state=open]>div]:text-blue-600">
      <div className="flex w-full items-center justify-between">
        ...
        {!isEnrolled && (
          <div className="flex items-center gap-2 rounded-full bg-red-100 px-3 py-1 border border-red-200">
          ...
          <div>
            {!isEnrolled ? (
              ...
              <Button
                ...
                className="flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg shadow-sm"
              >
        ...
        {!isEnrolled && (
          <div className="mt-4 rounded-lg border border-red-200 bg-red-50 p-3">
            <p className="text-sm text-red-600 font-medium">
              ...
              You need to enroll in this course to access the material
