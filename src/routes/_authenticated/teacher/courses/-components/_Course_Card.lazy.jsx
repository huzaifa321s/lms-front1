...
console.log("courseImg ===>",courseImg)
  ...
  `}
  sizes="(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 33.33vw, (max-width: 1280px) 25vw, 20vw"
  alt={name}
  className="w-full h-40 sm:h-48 object-cover"
  fetchpriority={index === 0 ? "high" : "auto"}
  decoding="async"
  loading={index === 0 ? "eager" : "lazy"}
  width="400" // Match typical image width
  height="192" // Match h-48 (48 * 4px = 192px)
/>
