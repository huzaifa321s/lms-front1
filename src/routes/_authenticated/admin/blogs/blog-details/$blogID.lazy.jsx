...
import { useParams, useSearch, useNavigate, createLazyFileRoute } from "@tanstack/react-router"
...
export const Route = createLazyFileRoute("/_authenticated/admin/blogs/blog-details/$blogID")({
