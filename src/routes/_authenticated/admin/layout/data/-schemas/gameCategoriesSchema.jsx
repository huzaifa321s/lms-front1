...
import { GameCategoryDataTableRowActions } from "../-table/game-category-data-table-row-actions";
import { z } from "zod";

const columnHelper = createColumnHelper()

export const gameCategoriesSchema = [
    ...
    }),
  {
    ...
    ),cell:({row}) =><div className="float-right"> <GameCategoryDataTableRowActions row={row}/></div>
  }
]
