...
export default function StudentsMetrics({ total, active, inactive, fetchStatus }) {
  const metrics = [
    { title: "Total Students", value: total, color: "bg-gradient-to-br from-[#2563eb] to-[#1d4ed8]" },
    { title: "Active Students", value: active, color: "bg-gradient-to-br from-[#10b981] to-[#059669]" },
    { title: "Inactive Students", value: inactive, color: "bg-gradient-to-br from-[#ef4444] to-[#dc2626]" },
  ];
