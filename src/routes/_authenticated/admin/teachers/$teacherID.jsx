...
import { useDebounceInput, useSearchInput, getFileUrl } from '@/utils/globalFunctions'
...
export const Route = createFileRoute(
  ...
  loader: async ({ params, context }) => {
    ; (await context.queryClient.ensureQueryData(
      teacherDetailsQueryOptions({ params: params })
    ),
      context.queryClient.prefetchQuery(courseQueryOption({ params: params, deps: { q: '', page: 1 } })))
  },
