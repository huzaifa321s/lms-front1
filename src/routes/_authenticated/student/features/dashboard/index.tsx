...
const ProfileDropdown = lazy(
  () => import('../tasks/-components/student-profile-dropdown')
)
const ChartBarLabelCustom = lazy(() => import('./-components/spendingByYear'))
                ...
                <CardHeader className='pb-2'>
                  <div className='flex items-center gap-2'>
                    ...
                    <div>
                      <p className='text-sm font-medium text-gray-600'>
                        Quiz Score{' '}
                        <span className='rounded-md bg-gray-800 px-2 py-1 text-sm font-medium text-white'>
                          Demo Feature
                        </span>
                      </p>
            ...
            {isSubscribed ? (
              <Card className='border border-gray-200'>
                ...
                <CardContent>
                  <Suspense
                    fallback={
                      <div className='h-32 w-full animate-pulse rounded-lg bg-gray-100'></div>
                    }
                  >
                  ...
                  <div className='flex flex-col items-center justify-center gap-2 py-8'>
                    ...
                    <div className='text-center'>
                      ...
                      <p className='text-gray-600'>
                        Subscribe to unlock detailed spending analytics
                      </p>
                    </div>
                    <Button
                      variant='outline'
