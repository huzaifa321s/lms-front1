      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 sticky top-8">
              <div className="text-center">
                    ...
                    <img
                      ...
                      src={
                        dp || credentials?.profile
                          ? `${import.meta.env.VITE_REACT_APP_STORAGE_BASE_URL}/student/profile/${credentials.profile}`
                          : defaultProfile
                      }
                      alt="Profile"
                    />
