...
function RouteComponent() {
  ...
  const coverImage = useMemo(() => {
    const baseUrl = import.meta.env.VITE_REACT_APP_STORAGE_BASE_URL;
  ...
  // Base material URL
  const baseMaterialUrl = `${import.meta.env.VITE_REACT_APP_STORAGE_BASE_URL}/courses/material`;
                              ...
                              <div className="space-y-3">
                                ...
                                {material.media && (
                                  <div>
                                    ...
                                    <div className="mt-2">
                                      <a
                                        href={`${baseMaterialUrl}/${material.media}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-2 font-medium text-white shadow-lg hover:scale-105 transition-all duration-200"
                                        aria-label={`Download ${material.media}`}
                                      >
                                        <svg
                                          className="h-4 w-4"
                                          fill="none"
